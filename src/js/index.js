...
// no entanto não temos a div de qual personagem clicamos, mas sim do botão do personagem, portanto utilizamos array


// para cada botão que percorre, ele adiciona evento toda vez que clicar.
botoes.forEach((botao, i) => {
    botao.addEventListener("click", () => {


        //  passo 3 - verificar se já existe um botão selecionado, se sim, devemos remover a seleção dele
        // o elemente que estiver a classe "selecionado", irá retirar
        ...
        // passo 2 - adicionar a classe "selecionado" no personagem que o usuário selecionou
        piratas[i].classList.add("selecionado");
    });
});